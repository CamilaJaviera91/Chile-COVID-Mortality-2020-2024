...
header = ['YEAR', 'REGION', 'DEATHS']  # Define the table headers
...
for _, row in df_count.iterrows():
    ...
    pdf.cell(col_widths[1], 10, str(row['NOMBRE_REGION']), border=1, align='C')  # Add 'NOMBRE_REGION' data
...
pdf.output(FOLDER + 'yearly_deaths_by_region.pdf')

print("PDF successfully created: 'yearly_deaths_by_region.pdf'")